...
const props = defineProps<{ isCreatePage?: boolean }>();
...
const submitForm = async () => {
  ...
  try {
    const response = await axios.post('/orders', formData.value, {
      headers: {
...
<template>
  <div class="container py-4">
    ...
    <h1 class="text-3xl font-bold mb-4">Create Order Baru</h1>
    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="d-flex justify-content-end">
        ...
        <button
          ...
          {{ props.isCreatePage ? 'Create' : 'Update' }}
        </button>
      </div>
    </form>
  </div>
